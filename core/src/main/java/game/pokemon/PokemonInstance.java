...
import game.pokemon.abilities.Ability;
import game.pokemon.abilities.AbilityFactory;
import game.pokemon.moves.BaseMove;
...
public class PokemonInstance {
    ...
    public static int getGenderThreshold(ObjectMap<String, Double> genderRatio) {
